...
command=matrix(c(
  ...
  'VIP', 'v', 1, 'double', 'opls-DA VIP cutoff: default VIP = 0',
...
# test
# peak_path = "/Users/shawnwang/20.other/zb/raw_peak.csv"
# group_path = "/Users/shawnwang/20.other/zb/group_info.csv"
# annotation_path = "/Users/shawnwang/20.other/zb/meta_anno.csv"
# VIP_cut = 1;
# left = "S50_2";
# right = "S50_WT";
# pval_cut = 1;
